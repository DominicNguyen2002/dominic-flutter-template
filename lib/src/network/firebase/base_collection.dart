...
import 'package:dominic_flutter_template/src/network/model/common/error_code.dart';
import 'package:dominic_flutter_template/src/network/model/common/result.dart';
import 'package:dominic_flutter_template/src/utils/list_utils.dart';
...
class BaseCollectionReference<T> {
  ...
  Future<MResult<List<T>>> getDataByIds(List<String> rooms) async {
    ...
    try {
      ...
      final spliceRooms = ListUtils.splice(rooms, 10);
